...
```
    ...
    mean of college: 0.39887
    share college for high income: 0.59856
    share college for low income: 0.19918



    
![png](Lecture2_Logistic_files/Lecture2_Logistic_3_1.png)
    


    average stress index for low income group: 3.6123
    average stress index for high income group: 0.0
    fraction insured: 0.3039



    
![png](Lecture2_Logistic_files/Lecture2_Logistic_3_3.png)
...
```
    ...
    fraction with good health: 0.34717
    fraction with good health among no school, low income, and uninsured: 0.0341
...
```
    ...
    the conversion of theta = 0.3 + mean stress value to prob: 0.0351 
...
```
    ...
    theta estimates from gradient descent: [[-0.2389  0.192   0.5794  0.38   -0.9031]] 
...
```
    ...
    Estimates from sklearn: [[ 0.25589713  0.11397403  0.24584297  0.02864795 -0.99104408]]
...
```
    ...
    Estimates from linear reg: [ 0.43718759  0.01654884  0.16951229  0.00369069 -0.10103997]
...
```
    ...
    The probability that person A is in good health is:[0.02924212] 
    
    The probability that person B is in good health is: [0.03521318] 
...
```
    ...
    [0.51392851 0.1614878  0.0131093  ... 0.5253499  0.46627795 0.66997023]
