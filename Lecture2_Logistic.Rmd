...
```
    ...
    mean of college: 0.40072
    share college for high income: 0.60098
    share college for low income: 0.20046
...
![png](Lecture2_Logistic_files/Lecture2_Logistic_3_1.png)
    ...
    average stress index for low income group: 3.593
    average stress index for high income group: 0.0068
    fraction insured: 0.29915
...
```
    ...
    fraction with good health: 0.34648
    fraction with good health among no school, low income, and uninsured: 0.0357
...
```
    ...
    the conversion of theta = 0.3 + mean stress value to prob: 0.036 
...
```
    ...
    theta estimates from gradient descent: [[-0.3148 -0.6818  1.1555  0.7523 -0.9126]] 
...
```
    ...
    Estimates from sklearn: [[ 0.28453132  0.10165842  0.20973576  0.05319063 -1.00181428]]
...
```
    ...
    Estimates from linear reg: [ 0.44234901  0.01574498  0.16142705  0.00745558 -0.1028531 ]
...
```
    ...
    The probability that person A is in good health is:[0.02688823] 
    
    The probability that person B is in good health is: [0.01378122] 
...
```
    ...
    [ 0.72596366  0.02636548 -0.13996585 ...  0.76890919  0.4717254
     -0.20695239]
