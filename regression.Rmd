...
if(user == "vinish-Legion-Pro-7-16IRX9H"){
    ...
    root_dir <- "/home/vinish/Dropbox/Machine Learning/book"
}else{
...
The above equality directly comes from the underlying assumption $E(\epsilon |X)=0$, or the independence of error term once conditioned on $X$.
...
The model allows for both intercept shift as well as changes in slope across gender.
